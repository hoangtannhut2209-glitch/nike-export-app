# -*- coding: utf-8 -*-
"""
Template routes for Nike Export Web App
"""
...
def preview_template(template_name):
    """Preview template content with original formatting"""
    try:
        ...
        current_app.logger.info(f"Loading workbook: {template_path}")
        ...
        for row_idx in range(1, max_row + 1):
            ...
            for col_idx in range(1, max_col + 1):
                ...
                try:
                    ...
                    'border': bool(cell.border and (cell.border.left.style or cell.border.right.style or cell.border.top.style or cell.border.bottom.style)),
                ...
                for merged_range in ws.merged_cells.ranges:
                    if cell.coordinate in merged_range:
                        cell_style['merged'] = True
                        cell_style['merge_range'] = str(merged_range)
                        break
        ...
        # Get print area and page setup info
        ...
        return jsonify({
            ...
            'used_range': f"{min_row}:{max_row}, {min_col}:{max_col}"
        })
